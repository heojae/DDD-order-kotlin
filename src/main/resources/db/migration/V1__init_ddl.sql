...
create index partner_idx01 on partners (partner_token);

create index partner_idx02 on partners (created_at);

create index partner_idx03 on partners (updated_at);